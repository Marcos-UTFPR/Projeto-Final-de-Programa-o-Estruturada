...
void RelatorioTanque (float combustivel); //Subrotina usada para cor dinâmica no relatório de litros restantes no tanque de gasolina//Limpa o buffer do teclado
void flush_in();
      ...
      case 2: //Abastecimento
        if (fila != 0){
          ...
          if (combustivel == 0){
            ...
            free (filaAtual); //Apaga o vetor que registra os caras atualmente na fila
            filaAtual = NULL;
          }    
        }
        else {
